        ...
        <div className='relative z-2 mb-16'>
            <div className="group relative flex cursor-pointer items-center justify-between gap-10 px-7" onClick={() => {
                ...
                <div className='flex-1'>
                    ...
                    <div className={clsx("h6 text-p4 transition-colors duration-500 max-md:flex max-md:min-h-20 max-md:items-center", activeId && "max-lg:text-p1")}>
                        {item.question}
                    </div>
                </div>
            ...
            <SlideDown>
                {activeId === item.id && (
                    <div className='body-3 p-7 py-3.5'>
                        {item.answer}
                    </div>
                )}
            </SlideDown>
            <div className={clsx('g5 -bottom-7 -top-7 left-0 right-0 -z-1 rounded-3xl transition-opacity duration-500  absolute opacity-0', active && "opacity-100")}>
